...
## description: "lowlighter/metrics@latest を使った GitHub プロフィール README と Actions 設定を日本語で作成する" name: "GitHub Profile Metrics 作成" argument-hint: "GitHubユーザー名、見せたい指標、デザイン方針（例: ミニマル/ポップ）" agent: "agent"
...
1. 構成方針の要約（3-5行）
1. `README.md` に貼るサンプル（Markdownコードブロック）
1. `.github/workflows/metrics.yml` の完成例（YAMLコードブロック）
1. 導入手順チェックリスト（番号付き）
1. カスタマイズ案（3案、各1-2行）
